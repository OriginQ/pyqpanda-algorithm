# SU(2) Color-Chain Quantum Simulation Tutorial：模型原理说明
...
5. connected color correlation between two probe sites 的计算。
...
## 6. connected color correlation between two probe sites

左右 probe site 的 connected color correlation 定义为：
...
这些结果用于展示 SU(2)-对称 color-chain 中的能谱结构、态保真度变化、局域 quench 响应和 connected probe-site correlation。
